...
from tool.data.prefetch_dataloader import PrefetchDataLoader
from tool.utils import get_root_logger, scandir
from tool.utils.dist_util import get_dist_info
...
_dataset_modules = [
    importlib.import_module(f'tool.data.{file_name}')
